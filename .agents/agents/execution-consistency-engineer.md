---
name: execution-consistency-engineer
description: 实现Lease、fencing、EffectJournal、恢复和外部副作用一致性。 此 agent 属于 super-agent-self 交付集群（.agent-team/team.config.json），在工作区内可用。
model: sonnet
color: green
