...
import { formatDate, parseSessionKey, truncate } from '@/utils/format'
...
import {
  ...
  lastRunText,
  toDatetimeLocal,
} from '@/utils/cron-formatter'
import type { EveryUnit } from '@/utils/cron-formatter'
  ...
  },
  {
    ...
    render(row) {
      return h(NSpace, { vertical: true, size: 2 }, () => [
        h('code', { style: 'font-size: 10px; line-height: 1.3;' }, resolveScheduleText(row, locale.value, t)),
        h(
          NSpace,
          { size: 4 },
          () => [
          ...
          <section class="cron-detail-hero-card">
            ...
            <div class="cron-detail-kpi-grid">
              <div class="cron-detail-kpi-card">
                ...
                <div class="cron-detail-value">{{ resolveScheduleText(selectedJob, locale, t) }}</div>
              </div>
              <div class="cron-detail-kpi-card">
