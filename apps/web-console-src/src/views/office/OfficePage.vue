...
async function handleSpawnSession(sessionKey: string) {
  try {
    ...
    message.error(getErrorMessage(e) || t('pages.sessions.list.newFailed'))
  }
}
...
async function handleCreateAgent() {
  ...
  try {
    ...
    message.error(getErrorMessage(e) || t('pages.agents.messages.createFailed'))
  } finally {
...
async function handleDeleteAgent(agentId: string) {
  try {
    ...
    message.error(getErrorMessage(e) || t('pages.agents.messages.deleteFailed'))
  }
}
...
async function handleSetIdentity() {
  ...
  try {
    ...
    message.error(getErrorMessage(e) || t('pages.agents.messages.identityFailed'))
  } finally {
...
async function handleSetModel() {
  ...
  try {
    ...
    message.error(getErrorMessage(e) || t('pages.agents.messages.modelFailed'))
  } finally {
    submitting.value = false
  }
}
...
async function handleSetTools() {
  ...
  try {
    ...
    message.error(getErrorMessage(e) || t('pages.agents.messages.toolsFailed'))
  } finally {
    submitting.value = false
  }
}
