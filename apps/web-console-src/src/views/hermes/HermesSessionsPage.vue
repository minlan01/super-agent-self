...
onMounted(() => {
  if (connStore.dashboardRequired) return
...
<template>
  <div class="hermes-sessions-page">
    ...
    >
      Hermes CLI v2026.5+ 已移除 Dashboard 子命令，Sessions（会话管理）功能暂时不可用。<br />
      可通过 <strong>Chat 页面</strong> 继续对话，或使用 <strong>Hermes CLI</strong> 管理会话。
    </NAlert>
