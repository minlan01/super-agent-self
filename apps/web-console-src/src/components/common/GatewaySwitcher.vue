...
import { useHermesConnectionStore, type GatewayId } from '@/stores/hermes/connection'
...
const options = [
  ...
  { label: 'Myself Agent', value: 'myself-agent' },
]
...
async function handleChange(val: string) {
  await connStore.switchGateway(val as GatewayId)
}
</script>
