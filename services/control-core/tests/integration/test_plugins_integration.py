...
class TestPluginsAuth:
    def test_list_requires_auth(self, app_and_client):
        client, _ = app_and_client
        resp = client.get("/api/v1/plugins/list")
        assert resp.status_code in (401, 403)

    def test_discover_requires_admin(self, app_and_client):
        client, _ = app_and_client
...
class TestPluginsEndpoints:
    def test_list_plugins(self, app_and_client, admin_token):
        client, _ = app_and_client
        resp = client.get(
            "/api/v1/plugins/list",
    ...
    def test_discover_plugins(self, app_and_client, admin_token):
        client, _ = app_and_client
        resp = client.post(
    ...
    def test_activate_not_found(self, app_and_client, admin_token):
        client, _ = app_and_client
        resp = client.post(
